...
public class TaxiOrderHeaderTest extends BaseTest {
    ...
    public void goToProfilePage() {
        ...
        order = useAPISteps.createTaxiOrder();
        orderId = order.getId();
    ...
    public void checkThatTheOrderPageIsOpenedWhichTheOrderNumberEnteredInTheSearchFieldEn() {
        try {
            logStep(1, "Check order number");
            orderHeaderPageSteps.orderTitleShouldHaveNumber(orderNumber);

            logStep(2, "Create taxi second new order");
            orderSecond = useAPISteps.createTaxiOrder();
