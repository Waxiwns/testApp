...
public class TaxiOrderTariffPageTest extends BaseTest {
    ...
    public void createOrderAndGoToCustomerTariffsTab(Order order) {
        ...
        discardChangesModalSteps.checkDiscardChangesDialogueAndClickOnTab();
        customerTariffsPageSteps.isActiveTab(CUSTOMER_TARIFFS);
        orderHeaderPageSteps.breadcrumbsServiceTypesTabShouldBeCorrectlyDisplayed(TAXI_SERVICE_TYPE, CUSTOMER_TARIFFS_URL);
    }
    ...
    public void checkPossibilityToTheProceedToTheCustomerTariffsSettingsForDeliveryArea() {
        createOrderAndGoToCustomerTariffsTab(useAPISteps.createTaxiOrder());
    ...
    public void checkTheMinimalDeliveryFeeField() {
        ...
        customerTariffsPageSteps.fieldShouldBeVisibleAndEmpty(DELIVERY, MINIMAL_FEE);
    }
    ...
    public void checkTheDeliveryFixedFeeField() {
        ...
        customerTariffsPageSteps.fieldShouldBeVisibleAndRequired(DELIVERY, RATE_PER_KM, MANDATORY_COST);
    }
    ...
    public void checkEnabledUsePreEstimatedDeliveryFeeField() {
        useAPISteps.updateServiceTypeCustomerTariffsDeliveryKharkiv(false, TAXI_SERVICE_TYPE, true);
        createOrderAndGoToCustomerTariffsTab(useAPISteps.createTaxiOrder());

        logStep(1, "Input operation area in 'Operation area' field");
        customerTariffsPageSteps.inputOperationArea(KHARKIV);

        logStep(2, "Check that the 'Use pre estimated Delivery Fee' field is displayed and on");
        ...
        useAPISteps.updateServiceTypeCustomerTariffsDeliveryKharkiv(false, TAXI_SERVICE_TYPE, false);
    }
    ...
    public void checkTheFreeCancellationTimeField() {
        ...
        customerTariffsPageSteps.fieldShouldBeVisibleAndHaveCost(CANCELLATION, FREE_TIME_CANCELLATION, MANDATORY_COST);
    }
