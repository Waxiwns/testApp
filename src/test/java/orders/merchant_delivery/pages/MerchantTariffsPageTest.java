...
@FixMethodOrder()
public class MerchantTariffsPageTest extends BaseTest {
    @BeforeEach
    public void goToProfilePage() {
        useAPISteps.updateServiceTypeCustomerTariffsDeliveryKharkiv(false, DELIVERY_SERVICE_TYPE, false);
    ...
    public void createOrderAndGoToCustomerTariffsTab(Order order) {
        ...
        orderHeaderPageSteps.breadcrumbsServiceTypesTabShouldBeCorrectlyDisplayed(DELIVERY_SERVICE_TYPE, CUSTOMER_TARIFFS_URL);
    }
    ...
    public void t01_checkPossibilityToTheProceedToTheCustomerTariffsSettingsForDeliveryArea() {
        createOrderAndGoToCustomerTariffsTab(useAPISteps.createRegularOrder(EMPTY_VALUE));
    ...
    public void t10_checkEnabledUsePreEstimatedDeliveryFeeField() {
        useAPISteps.updateServiceTypeCustomerTariffsDeliveryKharkiv(false, DELIVERY_SERVICE_TYPE, true);
        createOrderAndGoToCustomerTariffsTab(useAPISteps.createRegularOrder(EMPTY_VALUE));
