...
public class CourierOrderProfilePageDriverSectionTest extends BaseTest {
    ...
    @Test
    @Description("Courier order 'Driver' section: Check driver information displaying at 'Driver' section")
    ...
    @Test
    @Description("Courier order 'Driver' section: Check that 'Details' button at 'Driver' section leads to Driver Profile page")
    ...
    @Test
    @Description("Courier order 'Driver' section: Check 'Analyze' button functionality at 'Driver' section")
    ...
    @Test
    @Description("Courier order 'Driver' section: Check the 'Driver analyse' page")
    ...
    @Test
    @Description("Courier order 'Driver' section: Check the 'Change' button functionality in the 'Driver' section")
    ...
    @Test
    @Description("Courier order 'Driver' section: Check 'Show map'/'Show table' switcher functionality at 'Change Order Driver' form")
    public void checkShowMapShowTableSwitcherFunctionalityAtChangeOrderDriverForm() {
        ...
        changeDriverModalSteps.serviceTypeFilterFieldValueShouldBeCourier();
    ...
    @Test
    @Description("Courier order 'Driver' section: Check drivers displaying on the map of 'Change Order Driver' form")
    public void checkDriversDisplayingOnTheMapOfChangeOrderDriverForm() {
        createOrderAndGoToProfilePage(useAPISteps.createCourierOrderAndSecondDriverReadyAtLocation());
    ...
    @Test
    @Description("Courier order 'Driver' section: Check possibility to select driver via map at 'Change Order Driver' form")
    ...
    @Test
    @Description("Courier order 'Driver' section: Check possibility to assign driver via map at 'Change Order Driver' form")
    public void checkPossibilityToAssignDriverViaMapAtChangeOrderDriverForm() {
        createOrderAndGoToProfilePage(useAPISteps.createCourierOrderAndAcceptByDriver(firstDriver));
    ...
    @Test
    @Description("Courier order 'Driver' section: Check possibility to select driver via grid at 'Change Order Driver' form")
    ...
    @Test
    @Description("Courier order 'Driver' section: Check 'cross' and 'Close' buttons at 'Change Order Driver' form")
    ...
    @Test
    @Description("Courier order 'Driver' section: Check 'Order_execution' filter for 'Driver status' at 'Change Order Driver' form")
    public void checkOrderExecutionFilterForDriverStatusAtChangeOrderDriverForm() {
        ...
        changeDriverModalSteps.driversTableLineByIdCellsShouldHaveText(secondDriver.getId(), name, phone, car, ORDER_EXECUTION.getEnValue().replace("_", " "));
    }

    @Test
    @Description("Courier order 'Driver' section: Check 'Offline' filter for 'Driver status' at 'Change Order Driver' form")
    public void checkOfflineFilterForDriverStatusAtChangeOrderDriverForm() {
        createOrderAndGoToProfilePage(useAPISteps.createCourierCCOrderByFirstCustomer());
        secondDriver.checkActiveOrderAndCancelIt();
        secondDriver.waitForStatus(OFFLINE); // wait for 'OFFLINE' driver status
        ...
        changeDriverModalSteps.driversTableLineByIdCellsShouldHaveText(secondDriver.getId(), name, phone, car, OFFLINE.getEnValue());
    }

    @Test
    @Description("Courier order 'Driver' section: Check 'Order_Offline' filter for 'Driver status' at 'Change Order Driver' form")
    public void checkOrderOfflineFilterForDriverStatusAtChangeOrderDriverForm() {
        createOrderAndGoToProfilePage(useAPISteps.createCourierOrderAndAcceptByDriver(secondDriver));
        secondDriver.waitForStatus(ORDER_OFFLINE); // wait for 'ORDER OFFLINE' driver status
        ...
        changeDriverModalSteps.driversTableLineByIdCellsShouldHaveText(secondDriver.getId(), name, phone, car, ORDER_OFFLINE.getEnValue().replace("_", " "));
    }

    @Test
    @Description("Courier order 'Driver' section: Check 'Clear filter' button at 'Change Order Driver' form")
    public void checkClearFilterButtonAtChangeOrderDriverForm() {
        ...
        changeDriverModalSteps.driversTableLineByIdCellsShouldHaveText(secondDriver.getId(), name, phone, car, READY.getEnValue());
        changeDriverModalSteps.filterFieldValueShouldBe(DRIVER_STATUS, READY.getValue());
